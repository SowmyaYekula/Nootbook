...
def create_notes():
    ...
    Label(screen9, text="Please enter notes for the file below :").pack()
...
def view_notes():
    ...
    Label(screen11, text="Please use one of filenames below").pack()
...
def delete_notes():
    ...
    all_files = os.listdir()
    Label(screen13, text="Please use one of filenames below").pack()
...
def password_not_recognised():
    ...
    Label(screen4, text="Passeord not recognised..!").pack()
...
def register_user():
    ...
    Label(screen1, text = "Registration sucess", fg = "green", font = ("calidri", 11)).pack()
...
def main_screen():
    ...
    screen.title("signup 1.1")
    Label(text = "signup 1.1", bg = 'grey',width = "300", height = "2", font = ("Calibri", 13)).pack()
    Label(text = "").pack()
    Button(text = "Login", height = "2", width = "30", command = login).pack()
    Button(text = "Redister", height = "2", width = "30", command = register).pack()
